...
ALTER TABLE `tickets`
  ADD COLUMN IF NOT EXISTS `doctor_id` INT(11) NULL AFTER `organization_id`,
  ...
  ADD INDEX IF NOT EXISTS `idx_tickets_status` (`status`);
...
ALTER TABLE `prescriptions`
  ADD COLUMN IF NOT EXISTS `tracking_code` VARCHAR(50) NULL AFTER `id`,
  ADD INDEX IF NOT EXISTS `idx_rx_tracking` (`tracking_code`);
