...
24. **پنل داروساز، آپلود آنلاین نسخه و پیگیری مشتری (Pharmacist Panel & Prescription Workflow):**
    ...
    - **تب پیگیری نسخ در پروفایل مشتری:** اضافه شدن بخش «نسخه‌های من» در [`profile.php`](file:///opt/lampp/htdocs/asena/asena-enterprise/profile.php) (دسترسی با `?tab=prescriptions`) برای مشاهده کارت‌های نسخه‌های ارسالی، وضعیت بررسی داروساز، بارکد پیگیری، یادداشت‌های داروساز و پیش‌نمایش تصویر نسخه.
