...
<main class="w-full max-w-container-max mx-auto py-16 px-4">
    <div class="mb-10 text-center space-y-4">
        ...
        <p class="text-on-surface-variant text-lg">سوابق گفتگوهای شما با تیم پشتیبانی و کارشناسان آسنا</p>
    </div>
    ...
    <div class="bg-surface-container-lowest rounded-[2.5rem] p-8 shadow-sm border border-outline-variant/10">
        <?php if(empty($tickets)): ?>
            <div class="text-center py-16">
                ...
                <h3 class="text-xl font-bold text-on-surface mb-2">هیچ گفتگویی یافت نشد</h3>
                <p class="text-on-surface-variant mb-6">هنوز پیامی برای تیم پشتیبانی ارسال نکرده‌اید.</p>
