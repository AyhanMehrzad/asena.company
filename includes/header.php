...
<body class="bg-background text-on-background overflow-x-hidden">
    ...
    <header class="bg-primary shadow-md sticky top-0 z-50 transition-all">
        <div class="flex justify-between items-center w-full px-4 lg:px-8 py-4 flex-row">
            ...
            <div class="flex items-center gap-8 flex-1">
                ...
                <div class="hidden lg:flex items-center bg-white/10 rounded-full px-4 py-2 text-on-primary gap-2 w-full max-w-md">
                ...
                <div class="flex items-center gap-3">
                    <?php if(isset($_SESSION['user_id'])): ?>
                        ...
                        <?php elseif(isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'doctor'): ?>
                            <a href="doctor/index.php" class="bg-primary text-white px-6 py-2 rounded-lg font-label-lg btn-premium">پنل پزشک</a>
                        <?php endif; ?>
