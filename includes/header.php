...
$seo_defaults = [
    ...
    'organizations.php' => [
        'title' => 'مراکز درمانی و بیمارستان‌های تخصصی دامپزشکی کشور | آسنا',
        'desc'  => 'دایرکتوری جامع مراکز درمانی، بیمارستان‌ها، پلی‌کلینیک‌ها و اورژانس شبانه‌روزی دامپزشکی کشور.'
    ],
    'doctor_profile.php' => [
        'title' => 'پزشکان و جراحان متخصص دامپزشکی | نوبت‌دهی آنلاین - آسنا',
        'desc'  => 'پروفایل پزشک، سوابق جراحی، نظرات مراجعین و رزرو آنلاین نوبت ویزیت دامپزشکی در آسنا.'
    ],
    'organization_profile.php' => [
        'title' => 'پروفایل مرکز درمانی و کلینیک دامپزشکی | آسنا',
        'desc'  => 'اطلاعات بخش‌های درمانی، پزشکان همکار، تجهیزات و نوبت‌دهی مرکز درمانی دامپزشکی در آسنا.'
    ],
    'product_details.php' => [
