...
// === OAUTH CONFIGURATION ===
// Google OAuth Client ID & Secret strictly loaded from .env or official production keys
...
if (!empty($envRedirect)) {
    ...
    define('GOOGLE_REDIRECT_URI', 'https://asena.company/actions/oauth_callback.php');
}
...
define('APPLE_REDIRECT_URI', 'https://asena.company/actions/oauth_callback.php');
?>
