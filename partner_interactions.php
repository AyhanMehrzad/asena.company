...
if (!isset($_SESSION['user_id'])) {
    $_SESSION['redirect_after_login'] = 'partner_interactions.php';
...
<div class="max-w-[1350px] mx-auto space-y-6">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <form method="POST" action="partner_interactions.php?tab=sms" class="grid grid-cols-1 md:grid-cols-12 gap-3 pt-1">
                <?= csrf_field() ?>
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-5 hover:border-[#fd8100] transition">
                ...
                <div class="border-t border-slate-100 pt-4 space-y-3">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <form method="POST" action="partner_interactions.php" onsubmit="return confirm('آیا مایلید هزینه این بسته از موجودی کیف پول شما کسر گردد؟');">
                            <?= csrf_field() ?>
                        ...
                        <form method="POST" action="partner_interactions.php">
                            <?= csrf_field() ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-5 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <form method="POST" action="partner_interactions.php" class="space-y-4">
                <?= csrf_field() ?>
