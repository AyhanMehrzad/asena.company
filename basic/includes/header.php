...
?>
<!DOCTYPE html>
<html dir="rtl" lang="fa" data-edition="basic">
<head>
    <meta charset="utf-8">
    <meta content="width=device-width, initial-scale=1.0, maximum-scale=5.0, viewport-fit=cover" name="viewport">
    <title><?php echo isset($page_title) ? htmlspecialchars($page_title) : 'کلینیک و پت‌شاپ آسنا (نسخه پایه)'; ?></title>
    <meta name="description" content="<?php echo isset($page_description) ? htmlspecialchars($page_description) : 'سامانه نوبت‌دهی و پت‌شاپ پایه آسنا - ویژه کلینیک‌های تازه‌تاسیس'; ?>">
    ...
    <meta property="og:site_name" content="کلینیک و پت‌شاپ آسنا">
    <meta property="og:locale" content="fa_IR">
    <meta property="og:title" content="<?php echo isset($page_title) ? htmlspecialchars($page_title) : 'کلینیک و پت‌شاپ آسنا (نسخه پایه)'; ?>">
    <meta property="og:description" content="<?php echo isset($page_description) ? htmlspecialchars($page_description) : 'سامانه نوبت‌دهی و فروشگاه الکترونیک اقلام و ملزومات حیوانات'; ?>">
