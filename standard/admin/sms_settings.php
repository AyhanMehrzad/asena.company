        ...
        if (empty($testPhone) || strlen($testPhone) < 10) {
            ...
            if ($testType === 'otp') {
                ...
                $testResult = [
                    ...
                    'message' => $res ? "کد تایید آزمایشی ($code) با موفقیت به شماره $testPhone ارسال شد." : "ارسال پیامک با خطا مواجه شد. لاگ سیستم را بررسی کنید."
                ];
                ...
                $testResult = [
                    ...
                    'message' => $res ? "پیامک هشدار سفارش فرضی (#PC-$fakeOrderId) به شماره $testPhone ارسال شد." : "ارسال با خطا مواجه شد."
                ];
                ...
                $testResult = [
                    ...
                    'message' => $res ? "پیامک نوبت فرضی با موفقیت به شماره $testPhone ارسال شد." : "ارسال با خطا مواجه شد."
                ];
            } else {
                ...
                $testResult = [
                    'ok' => !empty($res),
                    'type' => 'پیامک مستقیم',
                    'message' => !empty($res) ? "پیامک مستقیم با موفقیت به $testPhone ارسال شد." : "خطا در ارسال پیامک مستقیم."
                ];
            }
