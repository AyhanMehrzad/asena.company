...
<aside id="admin-sidebar" class="fixed inset-y-0 right-0 w-64 bg-tertiary dark:bg-tertiary-container flex flex-col z-[70] lg:z-40 rtl shadow-lg transition-transform duration-300 translate-x-full lg:translate-x-0 overflow-y-auto">
    ...
    <nav class="flex-1 px-4 mt-4 space-y-1">
        ...
        $navItems = [
            'dashboard' => ['icon' => 'dashboard', 'title' => 'پیشخوان داروخانه', 'url' => 'index.php'],
            'orders' => ['icon' => 'local_shipping', 'title' => 'سفارشات دارویی', 'url' => 'orders.php'],
            'inventory' => ['icon' => 'medication', 'title' => 'انبار و داروها', 'url' => 'inventory.php'],
            ...
            'analytics' => ['icon' => 'analytics', 'title' => 'گزارش و آمار فروش', 'url' => 'analytics.php']
        ];
