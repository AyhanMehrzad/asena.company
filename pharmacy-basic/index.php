...
<main class="w-full max-w-container-max mx-auto space-y-24">
        ...
        <section class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div class="lg:col-span-9 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <a href="pharmacy.php" class="group workstation-module rounded-[2rem] p-8 cursor-pointer hover:-translate-y-1.5 transition-all block">
                    ...
                    <h3 class="font-bold text-primary text-lg mb-2 group-hover:text-primary-container flex items-center justify-between">
                        <span>تایید دیجیتال نسخه</span>
                        <span class="material-symbols-outlined text-sm opacity-0 group-hover:opacity-100 transition-opacity">arrow_forward</span>
                    </h3>
                    <p class="text-sm text-on-surface-variant leading-relaxed">آپلود سریع نسخه دامپزشک و بررسی اصالت توسط دکتر داروساز.</p>
                </a>
                ...
                <a href="pharmacy.php?tag=vaccines" class="group workstation-module rounded-[2rem] p-8 cursor-pointer hover:-translate-y-1.5 transition-all block">
                    ...
                    <h3 class="font-bold text-primary text-lg mb-2 group-hover:text-primary-container flex items-center justify-between">
                        <span>زنجیره سرد دارویی</span>
                        <span class="material-symbols-outlined text-sm opacity-0 group-hover:opacity-100 transition-opacity">arrow_forward</span>
                    </h3>
                    <p class="text-sm text-on-surface-variant leading-relaxed">بسته‌بندی عایق با کنترل دما (۲ تا ۸ درجه) برای واکسن و سرم.</p>
                </a>
                ...
                <a href="pharmacy.php?tag=vaccines" class="group workstation-module rounded-[2rem] p-8 cursor-pointer hover:-translate-y-1.5 transition-all block">
                    ...
                    <h3 class="font-bold text-primary text-lg mb-2 group-hover:text-primary-container flex items-center justify-between">
                        <span>واکسن و بیولوژیک</span>
                        <span class="material-symbols-outlined text-sm opacity-0 group-hover:opacity-100 transition-opacity">arrow_forward</span>
                    </h3>
                    <p class="text-sm text-on-surface-variant leading-relaxed">تامین مستقیم واکسن‌های دامی، طیور و پت با مجوز رسمی.</p>
                </a>
...
<!-- Interaction Layer -->
    <div class="fixed bottom-6 left-6 md:bottom-12 md:left-12 flex flex-col gap-3 md:gap-4 z-50">
        <a href="https://maps.google.com/?q=Tehran" target="_blank"
            ...
            <span
                class="absolute left-14 md:left-20 bg-white text-primary border border-outline-variant px-4 py-2 rounded-xl text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-xl">مسیریابی داروخانه</span>
        </a>
    </div>
...
$default_slides = [
    [
        'title' => "تامین مستقیم داروها<br />و واکسن‌های دامی",
        'desc' => "مرجع تخصصی داروهای دامپزشکی، مکمل‌های رشد و داروهای کمیاب انواع حیوانات خانگی و پرورشی با تاییدیه رسمی.",
        'badgeIcon' => "local_pharmacy",
        'badgeText' => "داروخانه آنلاین دامپزشکی",
        'link' => "pharmacy.php",
        'linkText' => "مشاهده لیست داروها",
        'img' => "assets/images/dog-hero.jpg"
    ],
    [
        'title' => "تایید دیجیتال نسخه<br />توسط دکتر داروساز",
        'desc' => "نسخه درمانی حیوان خود را به صورت آنلاین ارسال کرده و داروی تجویز شده را با دوز دقیق تحویل بگیرید.",
        'badgeIcon' => "receipt_long",
        'badgeText' => "ارسال و تایید آنلاین نسخه",
        'link' => "pharmacy.php",
        'linkText' => "ثبت و آپلود نسخه",
        'img' => "assets/images/cat-hero.jpg"
    ],
    [
        'title' => "توزیع امن با<br />زنجیره سرد دارویی",
        'desc' => "حفظ دمای استاندارد واکسن‌ها و سرم‌های حساس در تمام طول مسیر تا درب منزل یا فارم.",
        'badgeIcon' => "ac_unit",
        'badgeText' => "بسته‌بندی عایق با کنترل دما",
        'link' => "pharmacy.php?tag=vaccines",
        'linkText' => "واکسن و سرم‌های درمانی",
        'img' => "assets/images/toy-mouse.jpg"
    ],
    [
        'title' => "ملزومات بهداشتی<br />و مکمل‌های تقویتی",
        'desc' => "مجموعه‌ای کامل از مکمل‌های ویتامینه، مواد معدنی و ضدعفونی‌کننده‌های تخصصی انواع حیوانات.",
        'badgeIcon' => "medication",
        'badgeText' => "تضمین اصالت دارو",
        'link' => "shop.php",
